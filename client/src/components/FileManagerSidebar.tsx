        ...
        <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <div className="ml-4 space-y-1">
              <div className="flex items-center text-sm text-slate-300 py-1">
                <FolderOpen className="w-4 h-4 text-amber-400 mr-2" />
                <span>tags ({Object.values(tagCounts).reduce((a, b) => a + b, 0)})</span>
              </div>
              <div className="ml-4 space-y-1">
                {Object.entries(tagCounts).map(([tagType, count]) => (
                  <div key={tagType} className="flex items-center justify-between text-xs text-slate-400 py-1">
                    <div className="flex items-center">
                      <Folder className="w-3 h-3 text-amber-500 mr-2" />
                      <span>{tagType}</span>
                    </div>
